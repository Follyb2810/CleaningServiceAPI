        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CleaningFrequencyDays = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleanerAvailabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CleanerAvailabilities_Cleaners_CleanerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Cleaners_CleanerId",
                        column: x => x.CleanerId,
                        principalTable: "Cleaners",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CleaningFrequencyDays", "CreatedAt", "Description", "DurationHours", "IsActive", "Name", "Price" },
                values: new object[,]
                {
                    { 1, 7, new DateTimeOffset(new DateTime(2025, 8, 4, 14, 4, 4, 472, DateTimeKind.Unspecified).AddTicks(7790), new TimeSpan(0, 0, 0, 0, 0)), "Standard cleaning service every week", 3, true, "Weekly Standard", 80.00m },
                    { 2, 14, new DateTimeOffset(new DateTime(2025, 8, 4, 14, 4, 4, 472, DateTimeKind.Unspecified).AddTicks(7830), new TimeSpan(0, 0, 0, 0, 0)), "Standard cleaning service every two weeks", 4, true, "Bi-Weekly Standard", 90.00m },
                    { 3, 30, new DateTimeOffset(new DateTime(2025, 8, 4, 14, 4, 4, 472, DateTimeKind.Unspecified).AddTicks(7830), new TimeSpan(0, 0, 0, 0, 0)), "Deep cleaning service once a month", 6, true, "Monthly Deep Clean", 150.00m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CleanerAvailabilities_CleanerId_DayOfWeek",
                table: "CleanerAvailabilities",
                columns: new[] { "CleanerId", "DayOfWeek" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Cleaners_Email",
                table: "Cleaners",
                column: "Email",
                unique: true);
